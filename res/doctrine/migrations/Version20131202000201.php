 ...
 */
class Version20131202000201 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE players (id INT AUTO_INCREMENT NOT NULL, account_id INT DEFAULT NULL, statistic_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, class INT NOT NULL, create_date DATE NOT NULL, INDEX IDX_264E43A69B6B5FBA (account_id), UNIQUE INDEX UNIQ_264E43A653B6268F (statistic_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
